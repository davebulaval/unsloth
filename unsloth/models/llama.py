...
def _wrap_fast_inference(
    generate, device_type, dtype, model, num_logits_to_keep: bool = True
):
...
class FastLlamaModel:
    ...
    @staticmethod
    def for_inference(model, num_logits_to_keep: bool):
        ...
        if model.generate.__name__ != "_fast_generate":
            ...
            model.generate = _wrap_fast_inference(
                model.generate, device_type, dtype, model, num_logits_to_keep
            )
        pass
